...
import { Home, LogIn, LogOut, User, Pin, PinOff, MessageSquare, FileText, Edit } from 'lucide-react';
              ...
              {!isAuthenticated ? (
                <>
                  ...
                  <li>
                    ...
                    >
                      <Edit size={20} />
                      <span className={isCollapsed && !isMobile ? 'hidden' : 'block'}>Register</span>
                    </Link>
                  </li>
                </>
              ) : (
                <>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className={isCollapsed && !isMobile ? 'hidden' : 'block'}>Channels</span>
                    </Link>
                  </li>
                  ...
                  <li>
                    ...
                    >
                      <FileText size={20} />
                      <span className={isCollapsed && !isMobile ? 'hidden' : 'block'}>Posts</span>
                    </Link>
                  </li>
                </>
              )}
